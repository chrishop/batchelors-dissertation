...
% TODO: EXPAND critically analyse all of these sources, flesh this section out a little by
% adding some more papers?
...
% talk about it in the context of a parameter server, then that opens the way to
% talk about consistency models

% TODO: ADD section here looking at different scheduling for parameter servers
